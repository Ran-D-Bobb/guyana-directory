  ...
  return (
    <div className="space-y-6">
      ...
      <PhoneInput
        ...
        helperText="Primary contact method - renters will contact you via WhatsApp"
      />
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        <div className="flex gap-3">
          ...
          <div className="text-sm text-green-800">
            ...
            <p>WhatsApp is the most popular messaging app in Guyana. Renters can easily contact you with just one tap, making it faster and more convenient for everyone.</p>
          </div>
        </div>
      </div>
