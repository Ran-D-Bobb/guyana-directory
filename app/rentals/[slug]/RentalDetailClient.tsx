            ...
            <div className="lg:hidden bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl p-6 text-white">
              ...
              <div className="mt-6 pt-4 border-t border-white/30 space-y-3">
                {rental.phone && rental.phone !== null && (
                  <a href={`tel:${rental.phone}`} className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-white text-green-700 rounded-xl font-bold hover:bg-green-50 transition-all active:scale-95">
                    <Phone className="w-5 h-5" />
                    Call Now
                  </a>
                )}
            ...
            <div className="sticky top-24 space-y-4">
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-lg">
                ...
                <div className="space-y-3 mb-6">
                  {rental.phone && rental.phone !== null && (
                    <a href={`tel:${rental.phone}`} className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl font-bold hover:shadow-lg transition-all active:scale-95">
                      <Phone className="w-5 h-5" />
                      Call Now
                    </a>
                  )}
