      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl shadow-black/[0.04] border border-[hsl(var(--border))] p-6 sm:p-8">
          <div className="text-center mb-8">
            ...
            <h2 className="font-display text-2xl text-[hsl(var(--jungle-800))]">{t('resetPasswordTitle')}</h2>
            <p className="mt-2 text-[hsl(var(--jungle-600))] text-sm">{t('resetPasswordSubtitle')}</p>
          </div>
