      ...
      <div className="max-w-7xl mx-auto px-4 py-6 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {rental.description && (
              <div>
                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">{tb('about')}</h2>
            ...
            {totalReviews > 0 && (
              <div>
                <div className="flex items-center gap-3 mb-5">
                  <h2 className="text-xl font-bold text-gray-900 dark:text-white">{tb('reviews')}</h2>
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400">({tb('reviewsCount', { count: totalReviews })})</span>
                </div>
        ...
        {similarRentals.length > 0 && (
          <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-5">{tb('similarBusinesses')}</h2>
