...
export default async function RentalDetailPage({
  ...
  const { data: rental, error } = await supabase
    .from('rentals')
    .select(`
      id, name, slug, description, property_type, address, location_details,
      ...
      is_featured, is_approved, rating, review_count, view_count,
      rating_cleanliness, rating_location, rating_value, rating_communication,
  ...
  const { data: similarRentalsRaw } = await supabase
    .from('rentals')
    .select(`
      id, name, slug, description, property_type, price_per_month,
