...
export default async function Page({ params }: PageProps) {
  ...
  const kioskExperience = {
    ...
    video_url: (experience as Record<string, unknown>).video_url as string | null ?? null,
    video_thumbnail_url: (experience as Record<string, unknown>).video_thumbnail_url as string | null ?? null,
  }
